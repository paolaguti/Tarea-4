...
class ClienteApp():
    def __init__(self):
        ...
        tk.Label(self.loop, text="Cédula:", font=("Segoe UI", 10),
                 bg="#36506A", fg="#FFFFFF").grid(row=1, column=0, padx=10, pady=10, sticky="e")
        self.cedula_entry = tk.Entry(self.loop, font=("Segoe UI", 10), bg="#FFFFFF", fg="#000000")
        ...
        self.nombre_entry = tk.Entry(self.loop, font=("Segoe UI", 10), bg="#FFFFFF", fg="#000000")
        self.nombre_entry.grid(row=2, column=1, padx=10, pady=10, sticky="w")

        tk.Label(self.loop, text="Teléfono:", font=("Segoe UI", 10),
                 bg="#36506A", fg="#FFFFFF").grid(row=3, column=0, padx=10, pady=10, sticky="e")
        self.telefono_entry = tk.Entry(self.loop, font=("Segoe UI", 10), bg="#FFFFFF", fg="#000000")
